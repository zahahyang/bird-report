...
export const I18N = {
  zh: {
    ...
    subMain:'\u{1F440} 我看到鳥', subHear:'\u{1F442} 我聽到鳥', subEvents:'✨ 好事壞事', subAskmama:'🔮 說說話', subHeart:'🕊️ 啾啾樹洞',
    ...
    // heart
    heartTitle:'🕊️ 啾啾樹洞',
    hearTitle:'\u{1F442} 我聽到鳥', hearDesc:'聽到鳥叫卻沒看到牠？在楊媽媽的世界裡，鳴叫＝有消息在路上。跟媽媽說你在哪、那時候在想什麼或發生什麼，知道是哪種鳥再選（不知道也沒關係）。', hearBtn:'\u{1F442} 請媽媽聽聽這個聲音',
    ...
    tAskFirst:'先打一個想問的問題吧', tHearFirst:'說說你在哪、或那時候發生什麼吧', tPhotoFirst:'先拍一張或選一張照片喔', tMingliFirst:'先登入才能算自己的命理喔',
    ...
    loadHeart:'🕊️ 小鳥正帶著你的心事飛去給楊媽媽…', loadHearing:'👂 楊媽媽正在聽這個聲音帶來的消息…', loadOmen:'🍀 楊媽媽正在翻民俗的本子…',
  ...
  en: {
    ...
    subMain:'\u{1F440} I saw a bird', subHear:'\u{1F442} I heard a bird', subEvents:'✨ Good & Bad', subAskmama:'🔮 Talk', subHeart:'🕊️ Whisper Hollow',
    ...
    hearTitle:'\u{1F442} I heard a bird', hearDesc:"Heard a bird call but didn't see it? In Mama Yang's world, a call means a message is on its way. Tell Mama where you were and what was happening or on your mind; pick the species if you know it (no worries if you don't).", hearBtn:'\u{1F442} Let Mama listen to this call',
    ...
    tAskFirst:'Type a question first', tHearFirst:'Tell Mama where you were, or what was happening', tPhotoFirst:'Take or choose a photo first', tMingliFirst:'Sign in first to chart your own astrology',
    ...
    loadHeart:'🕊️ A little bird is carrying your heart to Mama…', loadHearing:'👂 Mama is listening to the news this call carries…', loadOmen:'🍀 Mama is flipping through the folklore book…',
